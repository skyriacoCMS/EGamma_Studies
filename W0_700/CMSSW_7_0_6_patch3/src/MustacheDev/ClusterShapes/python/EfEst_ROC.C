...
double lbckaos[19] =0 ;
  ...
  for(int i  = 0; i < 1000 ; i++){
    ...
    if( ef1[i]/sqrt(bk1[i]) > lbk1m){ lbk1m =  ef1[i]/sqrt(bk1[i]);  lbk1ms = ef1[i] ;  lbk1ao = lef1[i];                            };
    if( ef2[i]/sqrt(bk2[i]) > lbk2m){ lbk2m =  ef2[i]/sqrt(bk2[i]);  lbk2ms = ef2[i] ;  lbk2ao = lef2[i];                              };
    if( ef3[i]/sqrt(bk3[i]) > lbk3m){ lbk3m =  ef3[i]/sqrt(bk3[i]);  lbk3ms = ef3[i] ;  lbk3ao = lef3[i];                              };
    if( ef4[i]/sqrt(bk4[i]) > lbk4m){ lbk4m =  ef4[i]/sqrt(bk4[i]);  lbk4ms = ef4[i] ;  lbk4ao = lef4[i];                              };
    if( ef5[i]/sqrt(bk5[i]) > lbk5m){ lbk5m =  ef5[i]/sqrt(bk5[i]);  lbk5ms = ef5[i] ;  lbk5ao = lef5[i];                              };
    if( ef6[i]/sqrt(bk6[i]) > lbk6m){ lbk6m =  ef6[i]/sqrt(bk6[i]);  lbk6ms = ef6[i] ;  lbk6ao = lef6[i];                              };
    if( ef7[i]/sqrt(bk7[i]) > lbk7m){ lbk7m =  ef7[i]/sqrt(bk7[i]);  lbk7ms = ef7[i] ;  lbk7ao = lef7[i];                              };
    if( ef8[i]/sqrt(bk8[i]) > lbk8m){ lbk8m =  ef8[i]/sqrt(bk8[i]);  lbk8ms = ef8[i] ;  lbk8ao = lef8[i];                              };
    if( ef9[i]/sqrt(bk9[i]) > lbk9m){ lbk9m =  ef9[i]/sqrt(bk9[i]);  lbk9ms = ef9[i] ;  lbk9ao = lef9[i];                              };
